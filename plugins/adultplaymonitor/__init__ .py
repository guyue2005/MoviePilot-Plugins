...
class AdultPlayMonitor(_PluginBase):
    # 插件名称
    plugin_name = "Adult刮削"
    # 插件描述
    ...
    # 插件配置项ID前缀
    plugin_config_prefix = "adultplaymonitor_"
    # 加载顺序
    plugin_order = 26
    # 可使用的用户级别
    auth_level = 1
                                ...
                                'content': [
                                    {
                                        ...
                                        'props': {
                                            ...
                                            'variant': 'tonal',
                                            'text': '配置说明：'
                                                    'https://raw.githubusercontent.com/thsrite/MoviePilot-Plugins/main/docs/adultPlayMonitor.md'
                                        }
                                    }
                                ]
                            }
